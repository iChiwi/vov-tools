...
app = Flask(__name__)
# Use an environment variable or update for production
...
genai.configure(api_key=os.environ.get("GENAI_API_KEY", "YOUR_GENAI_API_KEY"))
    ...
    try:
        ...
        if current_track and current_track.get('is_playing'):
            ...
            if current_minute != last_minute:
                ...
                log_entry = f"[{time_left}] {track_name} - {artist_name}"
